...
function Statistika() {
  ...
  return (
<div className="md:flex items-end pb-10  justify-between">
     <div
        ...
        {data.map((item, index) => (
          <Grow in={checked} key={index} timeout={index * 500 + 1000}>
            <div
              ...
              className={`p-4 shadow-lg flex flex-row items-center cursor-pointer transform hover:scale-105 
    ...
    <div className="md:h-[100%] md:w-1/3 md:fixed right-0 bottom-0">
    <Natija></Natija>
    </div>
    </div>
  );
